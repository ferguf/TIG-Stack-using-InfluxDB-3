...
File: Scripts/billing/operations.py
"""
...
from scripts.billing import model as m
from scripts.billing import schema as s
...
def create_provider(db: Session, payload: s.BillingProviderCreate):
    ...
    db.refresh(new_prov)
    return new_prov
# Ensure list_models, list_rates, etc., are also exported here
