...
def init_session_state():
    ...
    if "target_asn" not in st.session_state: st.session_state["target_asn"] = "AS3356" # Dynamic Network Target
    if "inv_f_role" not in st.session_state: st.session_state["inv_f_role"] = "EBR"
